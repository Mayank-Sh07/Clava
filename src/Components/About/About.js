...
export default function About(props) {
  ...
  return (
    <div style={{backgroundColor:"#072b27"}}>
      ...
      <Paper className={classNames(classes.main, classes.mainRaised )}  style={{backgroundColor : "#1e1e1e"}}>
      ...
      <div className={classes.container}>
          ...
          <Typography variant='h4' className={classes.below} >
            <center>
            <LocalFloristIcon/> <br/>
                 <b> <u> Our Product Philosophy </u> </b> </center>
              </Typography>
              <br/> 
              ...
              Clava is a full service club management application based in India that was created by pairing together our passion for business and events. We bring a fresh, unique approach to the event management industry.
<br></br><br></br>Our team understands that a properly executed event can be leveraged to support an organization’s strategic vision, incorporated into a company’s marketing plan,
or used to build networks and client loyalty.
               </Typography>
               </paper>
        </Grid>
        </div>
  <Typography variant= 'h4' className={classes.below} > <center><b> <u> Core Commitee </u></b></center></Typography>  
  <br/> <br/> 
  ...
  <img src={require("../Images/alu1.svg") } height="200px" width="250px" alt="xyz"/> 
         </Grid>
         <Grid item xs={4} align='center' >
         <img src={require("../Images/alu2.svg") } height="200px" width="250px" alt="xyz"/> 
         </Grid> 
         <Grid item xs={4} align='center'>
          <img src={require("../Images/alu3.svg") } height="200px" width="250px" alt="xyz"/> 
         </Grid>
       </Grid>
          </Paper>
    </div>
