...
// initial context
export const ClavaThemeContext = React.createContext({
  currentTheme: "light",
  setTheme: null,
});
...
const ClavaThemeProvider = (props) => {
  ...
  return (
    <ClavaThemeContext.Provider value={themeContext}>
      <ThemeProvider theme={theme}>{children}</ThemeProvider>
    </ClavaThemeContext.Provider>
  );
};

export default ClavaThemeProvider;
